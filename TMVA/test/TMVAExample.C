...
factory->AddVariable("stop_mass",'F');                                             
factory->AddVariable("lsp_mass",'F');                                              
  */ 
...
//      gSystem->Exec("wget http://root.cern.ch/files/tmva_class_example.root");
   ...
   std::cout << "--- TMVAClassification       : Using input file background: " << inputbkg2->GetName() << std::endl;
   ...
   TCut mycuts = "(event%2)==1"; 
   TCut mycutb = "(event%2)==1"; 
